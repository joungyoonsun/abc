...
public class JHBoardController {
	...
	public String getJHBoardDetails(@PathVariable int categoryId, @PathVariable int jhId, @PathVariable int page, Model model, HttpSession session) {
		...
		model.addAttribute("page", page);
		JHBoard jhBoardDetails = jhBoardService.selectJHBoardArticle(jhId);
	...
	public String insertJHBoardArticle(@PathVariable int categoryId, Model model) {
...
//		model.addAttribute("categoryList", categoryList);
		...
		JHBoard jhBoard = jhBoardService.selectJHBoardArticle(jhId);
