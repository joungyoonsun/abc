...
public class ReplyController {
   ...
   public String BoardReply(ReplyVO reply,JHBoard jhboard, EmpBoard empBoard, BindingResult result, RedirectAttributes redirectAttrs, HttpSession session) {
      ...
      System.out.println("redirect:/empBoard/details/"+empBoard.getCategoryId() +"/"+empBoard.getEmpId() +"/1");
...
//   //Jhreply등록.post
   ...
   public String BoardReply2(ReplyVO reply,JHBoard jhboard, BindingResult result, RedirectAttributes redirectAttrs, HttpSession session) {
      logger.info("/reply:"+reply.toString());
      try {
         reply.setReplyContent(Jsoup.clean(reply.getReplyContent(), Whitelist.basic()));
      ...
      System.out.println("redirect:/jhBoard/details/"+jhboard.getCategoryId() +"/"+jhboard.getJhId() +"/1");
