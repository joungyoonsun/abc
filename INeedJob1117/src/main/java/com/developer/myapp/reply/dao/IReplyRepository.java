...
public interface IReplyRepository {
   ...
   //댓글 삭제
   String selectDeleteReply(@Param("boardReplyNumber") int replyId, @Param("userId") String userId);
   void deleteReplyByReplyId(@Param("boardReplyNumber") int replyId, @Param("userId") String userId);
